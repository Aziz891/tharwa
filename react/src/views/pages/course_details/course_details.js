...
class Course_details extends Component {
  ...
  constructor(props) {
    ...
    this.state = {data : this.props.location.state.data , originaldata : this.props.location.state.data ,value: '', file: '', showModal: false, redirect:false, newitem: this.props.location.state.newstudent};
    // this.form = {}
    // this.handleSubmit = this.handleSubmit.bind(this);
  }
  onChange(e) {
...
handleSubmit(e) {
  ...
  if (this.state.newitem == true){
    const res =  axios.post(urls.api + 'dashboard/course/' , formData);
    
  } else {
    const res =  axios.put(urls.api + 'dashboard/course/' + this.state.data.id + '/', formData);
  ...
  return (
    <>
        ...
        <CCol xs="12" sm="6">
          <CCard>
            ...
            <CCardBody>
              ...
              <CFormGroup>
                <CLabel htmlFor="vat">Instructor</CLabel>
                <CInput id="instructor"  value={this.state.data.instructor} onChange={(value) => this.onChange(value)} />
              </CFormGroup>
              <CFormGroup>
                <CLabel htmlFor="vat">Description</CLabel>
                <CTextarea id="description"  rows={3} value={this.state.data.description} onChange={(value) => this.onChange(value)} />
              </CFormGroup>
      ...
      <CCard>
          ...
          <Table_fx url={'student/'+ this.state.data.id} redirect={'/courses'} name={'courses'}
