...
const Student_details = React.lazy(() => import('./views/pages/student_details/student_details'));
const Courses = React.lazy(() => import('./views/pages/courses/courses'));
const Course_details = React.lazy(() => import('./views/pages/course_details/course_details'));
...
const routes = [
  ...
  { path: '/students', name: 'collected_data', component: Collected_Data },
  { path: '/dashboard', name: 'Dashboard', component: Dashboard },
  { path: '/student_details', name: 'Student_details', component: Student_details },
